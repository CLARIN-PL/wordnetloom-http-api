package pl.edu.pwr.wordnetloom.business.localistaion.entity;
...
@NamedQueries(@NamedQuery(name = LocalisedString.FIND_ALL ,query = "SELECT s FROM  LocalisedString s"))
